...
class smsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // 初始化用户Profile实例
        $profile = DefaultProfile::getProfile($this->sms['region'], $this->sms['accessKeyId'], $this->sms['accessKeySecret']);

        // 增加服务结点
        DefaultProfile::addEndpoint($this->sms['endPointName'], $this->sms['region'], $this->sms['product'], $this->sms['domain']);
