...
var Grid = FC.Grid = Class.extend(ListenerMixin, {
	...
	hasDayInteractions: true, // can users click/select ranges of time?
...
Grid.mixin({
	...
	unrenderEvents: function() {
		this.handleSegMouseout(); // trigger an eventMouseout if users's mouse is over an event
		this.clearDragListeners();
	...
	// Executes a handler for any a users-interaction on a segment.
...
/*
Responsible for event rendering and users-interaction.
