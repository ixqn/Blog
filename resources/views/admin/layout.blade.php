            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/admin/user/add') }}"><i class="fa fa-anchor"></i> 用户添加</a></li>
                        <li><a href="{{ url('/admin/user/index') }}"><i class="fa fa-asterisk"></i> 用户列表</a></li>
