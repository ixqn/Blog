...
<!--<![endif]--><head>
    ...
    <meta name="mobile-agent" content="format=html5;url=http://www.jianshu.com/subscriptions">
    ...
    <meta http-equiv="mobile-agent" content="format=html5; url=http://www.jianshu.com/subscriptions">
    ...
    <meta name="csrf-token" content="FMm7J5ribHzAhRDluwjM+k+72Zb1QwYKXM1vcIX1mizWO8E7/jqFsUHbpJWrvI3dYm6WUg61XGtXtJJdRUWoeA==">
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="width-limit">
        <!-- 左上方 Logo -->
        <a class="logo" href="http://www.jianshu.com/"><img src="{{ asset('./image/logo-58fd04f6f0de908401aa561cda6a0688.png') }}" alt="Logo"></a>
        ...
        <div class="user">
            <div data-hover="dropdown">
                <a class="avatar" href="http://www.jianshu.com/u/e0523455b58f"><img src="{{ asset('./image/7-0993d41a595d6ab6ef17b19496eb2f21.jpg') }}" alt="120"></a>
            </div>
            <ul class="dropdown-menu">
                <li>
                    <a href="http://www.jianshu.com/u/e0523455b58f">
                ...
                <li>
                    <a href="http://www.jianshu.com/users/e0523455b58f/liked_notes">
...
<div class="row"><div class="aside">
        ...
        <ul class="js-subscription-list"> <li class=""><div class="avatar-collection"></div>
                ...
                <li class=""><!---->
                    <div class="content">
                        <div class="author">
                            <a href="http://www.jianshu.com/u/66e5a0a26993" target="_blank" class="avatar">
                                <img src="{{ asset('./image/760e4724fae4_001.jpg') }}">
                            </a>
                            <div class="name">
                                <a href="{{ url('/home/userarticle') }}/{{ $item->user_id }}" target="_blank">
                                    {{ $item->article_author }}
                                </a><span>喜欢了文章 · 5小时前</span>
                            </div>
                        </div>
                        <a href="{{ url('/home/content') }}/{{ $item->article_id }}" target="_blank" class="title">
                            {{ $item->article_name }}
                        </a>
                        <p class="abstract">﻿{{ $item->article_cont }}</p>
                        <div class="meta">
                            <div class="origin-author">
                                <a href="http://www.jianshu.com/u/48db1bfffc94" target="_blank">同敬</a>
                            </div>
                            <a href="http://www.jianshu.com/p/a66a2b005f92?utm_source=desktop&amp;utm_medium=timeline" target="_blank">
                                <i class="iconfont ic-list-read"></i> 56
                            </a>
                            <a href="http://www.jianshu.com/p/a66a2b005f92#comments" target="_blank"><i class="iconfont ic-list-comments"></i> 4
