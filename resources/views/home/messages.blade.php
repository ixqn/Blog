...
<head>
    ...
    <meta name="mobile-agent" content="format=html5;url=http://www.jianshu.com/notifications">
    ...
    <meta http-equiv="mobile-agent" content="format=html5; url=http://www.jianshu.com/notifications">
    ...
    <meta name="csrf-token" content="ROV+ttMvRCUnJAgx2r6EJtcnTi1RmxGgYUYuJnRD26OMSfLi1lX/pC/50xBcilDJFCkDv1RDRj+bIwMnRyrH4g==" />

    <link rel="stylesheet" media="all" href="{{ asset('./css/web-e7e403d2843dd1edd8db.css') }}" />

    <link rel="stylesheet" media="all" href="{{ asset('./css/entry-266e0d4b3ebe57d6dd80.css') }}" />
    ...
    <div class="width-limit">
        ...
        <div class="user">
            <div data-hover="dropdown">
                <a class="avatar" href="/u/d6fc8a033b98"><img src="picture/72f15e83-7f50-45ab-af3a-d031fb4e8934.jpg" alt="120" /></a>
            </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="notification v-notification-dropdown-menu active">
