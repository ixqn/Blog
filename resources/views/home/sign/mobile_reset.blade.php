            ...
            <p>
                <form action="/doSignUp" method="POST" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="tel" class="form-control" id="tel" placeholder="请输入11位手机号码" aria-describedby="tel-addon" name="tel" value="{{ old('tel') }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="password" class="form-control" id="password" placeholder="字母、数字和下划线 , 8至20个字符" name="password" aria-describedby="password-addon" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="password" class="form-control" id="password_r" placeholder="请重新输入一遍密码" name="password_r" aria-describedby="password_r-addon" />
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8"">
                            <button type="button" id="submit" class="btn btn-danger btn-group-justified">重置密码</button>
                        </div>
                    </div>
...
function tel_func(){
    ...
    if(tel_flag){
        $.ajax({
            ...
            dataType:"json",
            async:false,
            success:function(is_telReg){ tel_flag = is_telReg; } // 必须是注册过的手机号才可重置密码
        });
    }
}
